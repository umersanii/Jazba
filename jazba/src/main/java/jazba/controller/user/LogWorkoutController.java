    ...
    private VBox createWorkoutNode(WorkoutPreset preset) {
        ...
        logworkout.setOnAction(e -> {
            try {
                ...
                int memberID = UserSession.getLoggedInUserID(); // Example system member ID for system-generated presets
                dao.LogWorkout(preset, memberID);
                AchievementDAO achievementDAO = new AchievementDAO();
                achievementDAO.checkAndUnlockAchievements(memberID);
...
private List<Exercise> getExercisesByWorkoutPresetID(int memberID) {
    ...
    public void showNotifications(ActionEvent event) {
        navigateTo("/jazba/view/user/Profile.fxml");
    }
