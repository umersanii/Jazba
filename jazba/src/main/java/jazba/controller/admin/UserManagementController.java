...
public class UserManagementController {
    ...
    private void populateUsersFromDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/jazbaDB", "root", "2cool4skool");
    ...
    private void showPopup(String details) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/jazba/view/admin/UserProfilePopup.fxml"));
